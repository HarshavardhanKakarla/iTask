...
function App() {
  ...
  return (
    <>
      <Navbar/>
      <div className="mx-3 md:container md:mx-auto my-20 rounded-xl p-5 bg-violet-100 min-h-[75] md:w-[35%]">
        <h1 className="font-bold text-center text-3xl">ITask - Manage your todo's</h1>
        ...
        <div className="bg-black opacity-15 mx-auto my-2 h-[1px] w-[90%]"></div>
      ...
      <p className='text-center place-content-end'>@ Can be developed further with more features.</p>
    </>
  )
}
